...
`),
  ...
  (e) => {
      ...
      return (
        ...
        w.forEach((i) => {
          r.push({
            ...
            priority: 0.8,
            images: [`${e}/projects/awd-immobilier.jpg`],
          });
        }),
        w.forEach((i) => {
          r.push({
    ...
    async function b() {
      let e = await R(),
        t = (0, $.resolveRouteData)(e, "sitemap");
    ...
    let E = new t.AppRouteRouteModule({
        ...
        distDir: ".next",
        relativeProjectDir: "",
        resolvedPagePath: "[project]/awdtech/app/sitemap--route-entry.js",
        nextConfigOutput: "",
        userland: _,
      }),
      { workAsyncStorage: A, workUnitAsyncStorage: C, serverHooks: q } = E;
    function j() {
    ...
    async function O(e, t, i) {
      ...
      let x = "/sitemap.xml/route";
      x = x.replace(/\/index$/, "") || "/";
      let w = await E.prepare(e, t, { srcPage: x, multiZoneDraftMode: !1 });
      if (!w)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        N = (0, s.normalizeAppPath)(x),
        S = !!(C.dynamicRoutes[N] || C.routes[T]),
        M = async () => (
          (null == q ? void 0 : q.render404)
            ? await q.render404(e, t, _, !1)
      ...
      try {
          ...
          s = async (n) => {
            ...
            let d = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  {
                    let e = await o.blob(),
                      t = (0, f.toNodeOutgoingHttpHeaders)(o.headers);
            ...
            return (
              (l && S) || c.delete(m.NEXT_CACHE_TAGS_HEADER),
              !u.cacheControl ||
        ...
        if (
          ...
          throw t;
        return (
          await (0, v.sendResponse)(L, G, new Response(null, { status: 500 })),
          null
        );
      }
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63108ea5._.js.map
