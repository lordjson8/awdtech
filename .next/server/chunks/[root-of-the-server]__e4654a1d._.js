    ...
    function l(e) {
      ...
      e)) {
        ...
        ((n += "<url>\n"),
          (n += `<loc>${s.url}</loc>
`));
        let e = null == (i = s.alternates) ? void 0 : i.languages;
  ...
  (e) => {
    ...
    function w() {
      return {
        ...
        sitemap: "https://awdtech.org/sitemap.xml",
        host: "https://awdtech.org",
      };
    }
    e.s(["default", () => w], 90122);
    var R = e.i(59015);
    ...
    let A = new t.AppRouteRouteModule({
        ...
        distDir: ".next",
        relativeProjectDir: "",
        resolvedPagePath: "[project]/awdtech/app/robots--route-entry.js",
        nextConfigOutput: "",
        userland: _,
      }),
      { workAsyncStorage: E, workUnitAsyncStorage: $, serverHooks: C } = A;
    function O() {
    ...
    async function q(e, t, o) {
      ...
      y = y.replace(/\/index$/, "") || "/";
      let w = await A.prepare(e, t, { srcPage: y, multiZoneDraftMode: !1 });
      if (!w)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        S = (0, s.normalizeAppPath)(y),
        k = !!(C.dynamicRoutes[S] || C.routes[P]),
        M = async () => (
          (null == O ? void 0 : O.render404)
            ? await O.render404(e, t, E, !1)
          ...
          s = async (n) => {
            ...
            let d = async ({ previousCacheEntry: r }) => {
                try {
                  ...
                  s && o.waitUntil && (o.waitUntil(s), (s = void 0));
            ...
            if (!k) return null;
            if (
              (null == u || null == (i = u.value) ? void 0 : i.kind) !==
            ...
            return (
              (l && k) || c.delete(m.NEXT_CACHE_TAGS_HEADER),
              !u.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4654a1d._.js.map
