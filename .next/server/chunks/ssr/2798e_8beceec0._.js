module.exports = [
  ...
  (a, b, c) => {
    ...
    (Object.defineProperty(c, "__esModule", { value: !0 }),
      ...
      a.r(36450).HTTP_ERROR_FALLBACK_ERROR_CODE,
      ("function" == typeof c.default ||
        ("object" == typeof c.default && null !== c.default)) &&
        void 0 === c.default.__esModule &&
        (Object.defineProperty(c.default, "__esModule", { value: !0 }),
  ...
  (a, b, c) => {
    ...
    let h = (d = a.r(61289)) && d.__esModule ? d : { default: d },
      i = a.r(94914),
      j = a.r(53183),
      k = a.r(32319),
      l = a.r(56704),
...
${b}`
  ...
  (a, b, c) => {
    ...
    let d = a.r(59823).unstable_rethrow;
    ("function" == typeof c.default ||
      ("object" == typeof c.default && null !== c.default)) &&
      void 0 === c.default.__esModule &&
      (Object.defineProperty(c.default, "__esModule", { value: !0 }),
  ...
  (a, b, c) => {
    ...
    let f = a.r(11615)._(a.r(61289)),
      ...
      l = a.r(92711),
      m = a.r(91817),
      n = a.r(22346).useDynamicRouteParams,
      o = a.r(22346).useDynamicSearchParams;
    function p() {
      o?.("useSearchParams()");
  ...
  (a) => {
    ...
    function u(a, b) {
      var c = b && b.cache ? b.cache : z,
        d = b && b.serializer ? b.serializer : x;
      return (
        b && b.strategy
          ? b.strategy
          : function (a, b) {
      ...
      )(a, { cache: c, serializer: d });
    }
    function v(a, b, c, d) {
      var e =
          null == d || "number" == typeof d || "boolean" == typeof d ? d : c(d),
        f = b.get(e);
      return (void 0 === f && ((f = a.call(this, d)), b.set(e, f)), f);
    }
    function w(a, b, c) {
      var d = Array.prototype.slice.call(arguments, 3),
        e = c(d),
        f = b.get(e);
      return (void 0 === f && ((f = a.apply(this, d)), b.set(e, f)), f);
    }
    ...
    function I(a) {
      return !!(a && "object" == typeof a && a.type === j.number);
    }
    function J(a) {
      return !!(a && "object" == typeof a && a.type === j.dateTime);
    }
    (((b = h || (h = {}))[(b.EXPECT_ARGUMENT_CLOSING_BRACE = 1)] =
      ...
      (c[(c.pound = 7)] = "pound"),
      (c[(c.tag = 8)] = "tag"),
      ((d = j || (j = {}))[(d.number = 0)] = "number"),
      (d[(d.dateTime = 1)] = "dateTime"));
    var K = /[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/,
      L =
    ...
    function R(a) {
      ...
      return (
        "r" === a[a.length - 1]
          ? (b.roundingPriority = "morePrecision")
          : "s" === a[a.length - 1] && (b.roundingPriority = "lessPrecision"),
        a.replace(O, function (a, c, d) {
          return (
            "string" != typeof d
              ? ((b.minimumSignificantDigits = c.length),
                (b.maximumSignificantDigits = c.length))
              : "+" === d
                ? (b.minimumSignificantDigits = c.length)
                : "#" === c[0]
                  ? (b.maximumSignificantDigits = c.length)
                  : ((b.minimumSignificantDigits = c.length),
                    (b.maximumSignificantDigits =
                      c.length + ("string" == typeof d ? d.length : 0))),
            ""
          );
        }),
        b
    ...
    var U = {
      ...
      V = new RegExp("^".concat(K.source, "*")),
      W = new RegExp("".concat(K.source, "*$"));
    function X(a, b) {
    ...
    var Y = !!String.prototype.startsWith && "_a".startsWith("a", 1),
      ...
      aa = !!String.prototype.trimStart,
      ab = !!String.prototype.trimEnd,
      ac = Number.isSafeInteger
    ...
    try {
      ad =
        (null ==
        (k = ak("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a"))
          ? void 0
          : k[0]) === "a";
    } catch (a) {
      ad = !1;
        ...
        : function (a, b) {
            ...
            if (!(b < 0) && !(b >= d)) {
              ...
              return e < 55296 ||
                e > 56319 ||
                b + 1 === d ||
                (c = a.charCodeAt(b + 1)) < 56320 ||
                c > 57343
                ? e
                : ((e - 55296) << 10) + (c - 56320) + 65536;
            }
          },
      ai = aa
        ? function (a) {
    ...
    if (ad) {
      var al = ak("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
      l = function (a, b) {
        var c;
        return ((al.lastIndex = b), null != (c = al.exec(a)[1]) ? c : "");
      };
    } else
      l = function (a, b) {
        for (var c = []; ; ) {
          ...
          if (
            ...
            break;
          (c.push(e), (b += e >= 65536 ? 2 : 1));
        }
        return af.apply(void 0, c);
      };
    var am = (function () {
      function a(a, b) {
        (void 0 === b && (b = {}),
          ...
          (this.ignoreTag = !!b.ignoreTag),
          (this.locale = b.locale),
          (this.requiresOtherClause = !!b.requiresOtherClause),
          (this.shouldParseSkeletons = !!b.shouldParseSkeletons));
      }
      return (
        ...
        (a.prototype.parseMessage = function (a, b, c) {
          for (var d = []; !this.isEOF(); ) {
            var e = this.char();
            if (123 === e) {
              var f = this.parseArgument(a, c);
              if (f.err) return f;
              d.push(f.val);
            } else if (125 === e && a > 0) break;
            else if (35 === e && ("plural" === b || "selectordinal" === b)) {
            ...
            } else if (60 !== e || this.ignoreTag || 47 !== this.peek())
              if (60 === e && !this.ignoreTag && an(this.peek() || 0)) {
                var f = this.parseTag(a, b);
                if (f.err) return f;
                d.push(f.val);
              } else {
                var f = this.parseLiteral(a, b);
                if (f.err) return f;
                d.push(f.val);
              }
            else if (!c)
          ...
          return { val: d, err: null };
        }),
        (a.prototype.parseTag = function (a, b) {
          var c = this.clonePosition();
          this.bump();
          var d = this.parseTagName();
          if ((this.bumpSpace(), this.bumpIf("/>")))
            return {
              val: {
                type: i.literal,
                value: "<".concat(d, "/>"),
                location: X(c, this.clonePosition()),
              },
              err: null,
            };
          if (!this.bumpIf(">"))
            return this.error(h.INVALID_TAG, X(c, this.clonePosition()));
          var e = this.parseMessage(a + 1, b, !0);
          if (e.err) return e;
          var f = e.val,
            g = this.clonePosition();
          if (!this.bumpIf("</"))
            return this.error(h.UNCLOSED_TAG, X(c, this.clonePosition()));
          if (this.isEOF() || !an(this.char()))
            return this.error(h.INVALID_TAG, X(g, this.clonePosition()));
          var j = this.clonePosition();
          return d !== this.parseTagName()
            ? this.error(h.UNMATCHED_CLOSING_TAG, X(j, this.clonePosition()))
            : (this.bumpSpace(), this.bumpIf(">"))
              ...
              : this.error(h.INVALID_TAG, X(g, this.clonePosition()));
        }),
        (a.prototype.parseTagName = function () {
          ...
          for (
            ...
            this.bump();
          return this.message.slice(b, this.offset());
        }),
        (a.prototype.parseLiteral = function (a, b) {
          for (var c = this.clonePosition(), d = ""; ; ) {
            var e = this.tryParseQuote(b);
            if (e) {
              d += e;
              continue;
            }
            var f = this.tryParseUnquoted(a, b);
            if (f) {
              d += f;
              continue;
            }
            var g = this.tryParseLeftAngleBracket();
            if (g) {
              d += g;
              continue;
            }
          ...
          var h = X(c, this.clonePosition());
          return { val: { type: i.literal, value: d, location: h }, err: null };
        }),
        (a.prototype.tryParseLeftAngleBracket = function () {
          var a;
          return this.isEOF() ||
            60 !== this.char() ||
            (!this.ignoreTag && (an((a = this.peek() || 0)) || 47 === a))
            ? null
            : (this.bump(), "<");
        }),
        (a.prototype.tryParseQuote = function (a) {
          ...
          for (this.bump(); !this.isEOF(); ) {
            var c = this.char();
            if (39 === c)
              if (39 === this.peek()) (b.push(39), this.bump());
              else {
                this.bump();
                break;
              }
          ...
          return af.apply(void 0, b);
        }),
        (a.prototype.tryParseUnquoted = function (a, b) {
          if (this.isEOF()) return null;
          var c = this.char();
          return 60 === c ||
            123 === c ||
            (35 === c && ("plural" === b || "selectordinal" === b)) ||
            (125 === c && a > 0)
            ? null
            : (this.bump(), af(c));
        }),
        (a.prototype.parseArgument = function (a, b) {
          var c = this.clonePosition();
          if ((this.bump(), this.bumpSpace(), this.isEOF()))
            return this.error(
              h.EXPECT_ARGUMENT_CLOSING_BRACE,
              X(c, this.clonePosition()),
            );
          if (125 === this.char())
            return (
              this.bump(),
              this.error(h.EMPTY_ARGUMENT, X(c, this.clonePosition()))
            );
          var d = this.parseIdentifierIfPossible().value;
          if (!d)
            return this.error(h.MALFORMED_ARGUMENT, X(c, this.clonePosition()));
          ...
          switch (this.char()) {
            ...
            case 44:
              ...
              return this.parseArgumentOptions(a, b, d, c);
            default:
              return this.error(
        ...
        (a.prototype.parseIdentifierIfPossible = function () {
          ...
          return (
            this.bumpTo(d),
            { value: c, location: X(a, this.clonePosition()) }
          );
        }),
        (a.prototype.parseArgumentOptions = function (a, b, c, d) {
          var e,
            f = this.clonePosition(),
            g = this.parseIdentifierIfPossible().value,
            k = this.clonePosition();
          switch (g) {
            case "":
              return this.error(h.EXPECT_ARGUMENT_TYPE, X(f, k));
            case "number":
            case "date":
            case "time":
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                l = { style: o, styleLocation: X(m, this.clonePosition()) };
              }
              var p = this.tryParseArgumentClose(d);
              if (p.err) return p;
              var q = X(d, this.clonePosition());
              if (l && ae(null == l ? void 0 : l.style, "::", 0)) {
                var s = ai(l.style.slice(2));
                if ("number" === g) {
                  var n = this.parseNumberSkeletonFromString(
                    s,
                    l.styleLocation,
                  );
                  if (n.err) return n;
                ...
                if (0 === s.length)
                  return this.error(h.EXPECT_DATE_TIME_SKELETON, q);
                var t,
                  u = s;
                this.locale &&
                  (u = (function (a, b) {
                ...
                var o = {
                  ...
                  parsedOptions: this.shouldParseSkeletons
                    ? ((t = {}),
                      u.replace(L, function (a) {
                        var b = a.length;
                        switch (a[0]) {
                          case "G":
                            t.era =
                              4 === b ? "long" : 5 === b ? "narrow" : "short";
                            break;
                          case "y":
                            t.year = 2 === b ? "2-digit" : "numeric";
                            break;
                          case "Y":
                          case "u":
                          case "U":
                          ...
                          case "m":
                            t.minute = ["numeric", "2-digit"][b - 1];
                            break;
                          case "s":
                            t.second = ["numeric", "2-digit"][b - 1];
                            break;
                          case "S":
                          case "A":
                            throw RangeError(
              ...
              return {
                val: {
                  type:
                    "number" === g ? i.number : "date" === g ? i.date : i.time,
                  value: c,
                  location: q,
                  style: null != (e = null == l ? void 0 : l.style) ? e : null,
                },
                err: null,
              };
            case "plural":
            ...
            case "select":
              ...
              var y = this.tryParsePluralOrSelectOptions(a, g, b, w);
              if (y.err) return y;
              var p = this.tryParseArgumentClose(d);
              if (p.err) return p;
              var z = X(d, this.clonePosition());
              if ("select" === g)
                return {
                  val: {
                    type: i.select,
            ...
            default:
              return this.error(h.INVALID_ARGUMENT_TYPE, X(f, k));
          }
        }),
        (a.prototype.tryParseArgumentClose = function (a) {
          return this.isEOF() || 125 !== this.char()
            ? this.error(
                h.EXPECT_ARGUMENT_CLOSING_BRACE,
                X(a, this.clonePosition()),
              )
            : (this.bump(), { val: !0, err: null });
        }),
        (a.prototype.parseSimpleArgStyleIfPossible = function () {
          for (var a = 0, b = this.clonePosition(); !this.isEOF(); )
            switch (this.char()) {
              case 39:
                this.bump();
                var c = this.clonePosition();
              ...
              case 125:
                if (!(a > 0))
                  return {
                    val: this.message.slice(b.offset, this.offset()),
                    err: null,
                  };
                a -= 1;
                break;
        ...
        (a.prototype.parseNumberSkeletonFromString = function (a, b) {
          var c = [];
          try {
            c = (function (a) {
              if (0 === a.length)
              ...
              for (
                var b = a.split(M).filter(function (a) {
                    return a.length > 0;
                  }),
                  c = [],
                  d = 0;
                ...
                for (var f = e[0], g = e.slice(1), h = 0; h < g.length; h++)
                  if (0 === g[h].length) throw Error("Invalid number skeleton");
                c.push({ stem: f, options: g });
              }
              return c;
            })(a);
          } catch (a) {
            return this.error(h.INVALID_NUMBER_SKELETON, b);
          }
          return {
            val: {
              type: j.number,
                    ...
                    for (var b = {}, c = 0; c < a.length; c++) {
                      ...
                      switch (d.stem) {
                        ...
                        case "%":
                          ...
                          continue;
                        case "%x100":
                          ((b.style = "percent"), (b.scale = 100));
                          continue;
                        case "currency":
                          ((b.style = "currency"), (b.currency = d.options[0]));
                          continue;
                        case "group-off":
                        case ",_":
                          b.useGrouping = !1;
                        ...
                        case ".":
                          b.maximumFractionDigits = 0;
                          continue;
                        case "measure-unit":
                        case "unit":
                          ((b.style = "unit"),
                            (b.unit = d.options[0].replace(/^(.*?)-/, "")));
                          continue;
                        case "compact-short":
                        case "K":
                          ((b.notation = "compact"),
                            (b.compactDisplay = "short"));
                          continue;
                        case "compact-long":
                        case "KK":
                          ((b.notation = "compact"),
                            (b.compactDisplay = "long"));
                          continue;
                        case "scientific":
                          b = r(
                            r(r({}, b), { notation: "scientific" }),
                            d.options.reduce(function (a, b) {
                              return r(r({}, a), T(b));
                            }, {}),
                          );
                          continue;
                        ...
                        case "unit-width-narrow":
                          ((b.currencyDisplay = "narrowSymbol"),
                            (b.unitDisplay = "narrow"));
                          continue;
                        case "unit-width-short":
                          ((b.currencyDisplay = "code"),
                            (b.unitDisplay = "short"));
                          continue;
                        case "unit-width-full-name":
                          ((b.currencyDisplay = "name"),
                            (b.unitDisplay = "long"));
                          continue;
                        case "unit-width-iso-code":
                          ...
                          continue;
                        case "scale":
                          b.scale = parseFloat(d.options[0]);
                          continue;
                        case "rounding-mode-floor":
                          b.roundingMode = "floor";
                          continue;
                        case "rounding-mode-ceiling":
                          b.roundingMode = "ceil";
                          continue;
                        case "rounding-mode-down":
                          b.roundingMode = "trunc";
                          continue;
                        case "rounding-mode-up":
                          b.roundingMode = "expand";
                          continue;
                        case "rounding-mode-half-even":
                          b.roundingMode = "halfEven";
                          continue;
                        case "rounding-mode-half-down":
                          b.roundingMode = "halfTrunc";
                          continue;
                        case "rounding-mode-half-up":
                          b.roundingMode = "halfExpand";
                          continue;
                        case "integer-width":
                          ...
                          d.options[0].replace(P, function (a, c, d, e, f, g) {
                            if (c) b.minimumIntegerDigits = d.length;
                            else if (e && f)
                              throw Error(
                      ...
                      if (Q.test(d.stem)) {
                        b.minimumIntegerDigits = d.stem.length;
                        continue;
                      }
                      if (N.test(d.stem)) {
                        if (d.options.length > 1)
                        ...
                        d.stem.replace(N, function (a, c, d, e, f, g) {
                          return (
                            "*" === d
                              ? (b.minimumFractionDigits = c.length)
                              : e && "#" === e[0]
                                ? (b.maximumFractionDigits = e.length)
                                : f && g
                                  ? ((b.minimumFractionDigits = f.length),
                                    (b.maximumFractionDigits =
                                      f.length + g.length))
                                  : ((b.minimumFractionDigits = c.length),
                                    (b.maximumFractionDigits = c.length)),
                            ""
                          );
                        });
                        var e = d.options[0];
                      ...
                      var g = (function (a) {
                        ...
                        if (
                          ("E" === a[0] && "E" === a[1]
                            ? ((b = { notation: "engineering" }),
                              (a = a.slice(2)))
                            : "E" === a[0] &&
                              ((b = { notation: "scientific" }),
                              (a = a.slice(1))),
                          b)
                        ) {
                          var c = a.slice(0, 2);
                          if (
                            ("+!" === c
                              ? ((b.signDisplay = "always"), (a = a.slice(2)))
                              : "+?" === c &&
                                ((b.signDisplay = "exceptZero"),
                                (a = a.slice(2))),
                            !Q.test(a))
                          )
                            throw Error(
                          ...
                          b.minimumIntegerDigits = a.length;
                        }
                        return b;
                      })(d.stem);
                      g && (b = r(r({}, b), g));
        ...
        (a.prototype.tryParsePluralOrSelectOptions = function (a, b, c, d) {
          for (
            var e, f = !1, g = [], i = new Set(), j = d.value, k = d.location;
            ;
          ) {
            if (0 === j.length) {
              var l = this.clonePosition();
              if ("select" !== b && this.bumpIf("=")) {
                var m = this.tryParseDecimalInteger(
                  h.EXPECT_PLURAL_ARGUMENT_SELECTOR,
                  h.INVALID_PLURAL_ARGUMENT_SELECTOR,
                );
                if (m.err) return m;
                ((k = X(l, this.clonePosition())),
                  (j = this.message.slice(l.offset, this.offset())));
              } else break;
            }
            if (i.has(j))
              return this.error(
            ...
            var o = this.parseMessage(a + 1, b, c);
            if (o.err) return o;
            var p = this.tryParseArgumentClose(n);
            if (p.err) return p;
            (g.push([
              j,
              { value: o.val, location: X(n, this.clonePosition()) },
            ]),
              i.add(j),
              this.bumpSpace(),
              (j = (e = this.parseIdentifierIfPossible()).value),
              (k = e.location));
          }
          return 0 === g.length
            ? this.error(
        ...
        (a.prototype.tryParseDecimalInteger = function (a, b) {
          var c = 1,
            d = this.clonePosition();
          this.bumpIf("+") || (this.bumpIf("-") && (c = -1));
          for (var e = !1, f = 0; !this.isEOF(); ) {
            var g = this.char();
            if (g >= 48 && g <= 57)
              ((e = !0), (f = 10 * f + (g - 48)), this.bump());
            else break;
          }
        ...
        (a.prototype.char = function () {
          ...
          var b = ah(this.message, a);
          if (void 0 === b)
            throw Error(
              "Offset ".concat(a, " is at invalid UTF-16 code unit boundary"),
            );
          return b;
        }),
        (a.prototype.error = function (a, b) {
          return {
            val: null,
            err: { kind: a, message: this.message, location: b },
          };
        }),
        (a.prototype.bump = function () {
          if (!this.isEOF()) {
            ...
            10 === a
              ...
              : ((this.position.column += 1),
                (this.position.offset += a < 65536 ? 1 : 2));
          }
        }),
        (a.prototype.bumpIf = function (a) {
          if (ae(this.message, a, this.offset())) {
            for (var b = 0; b < a.length; b++) this.bump();
            return !0;
          }
          return !1;
        }),
        (a.prototype.bumpUntil = function (a) {
          var b = this.offset(),
            c = this.message.indexOf(a, b);
          return c >= 0
            ? (this.bumpTo(c), !0)
            : (this.bumpTo(this.message.length), !1);
        }),
        (a.prototype.bumpTo = function (a) {
          if (this.offset() > a)
            throw Error(
              "targetOffset "
                .concat(
        ...
        (a.prototype.bumpSpace = function () {
          for (; !this.isEOF() && ao(this.char()); ) this.bump();
        }),
        (a.prototype.peek = function () {
          if (this.isEOF()) return null;
          var a = this.char(),
            b = this.offset(),
            c = this.message.charCodeAt(b + (a >= 65536 ? 2 : 1));
    ...
    function ap(a, b) {
      ...
      var c = new am(
        a,
        (b = r({ shouldParseSkeletons: !0, requiresOtherClause: !0 }, b)),
      ).parse();
      if (c.err) {
        var d = SyntaxError(h[c.err.kind]);
        throw (
          (d.location = c.err.location),
          (d.originalMessage = c.err.message),
          d
        );
      }
      return (
        (null == b ? void 0 : b.captureLocation) ||
          (function a(b) {
            b.forEach(function (b) {
              if ((delete b.location, F(b) || G(b)))
                for (var c in b.options)
                  (delete b.options[c].location, a(b.options[c].value));
              else
                (C(b) && I(b.style)) || ((D(b) || E(b)) && J(b.style))
                  ? delete b.style.location
                  : H(b) && a(b.children);
            });
          })(c.val),
        c.val
    ...
    (((e = m || (m = {})).MISSING_VALUE = "MISSING_VALUE"),
      (e.INVALID_VALUE = "INVALID_VALUE"),
      (e.MISSING_INTL_API = "MISSING_INTL_API"));
    var aq = (function (a) {
        function b(b, c, d) {
          var e = a.call(this, b) || this;
          return ((e.code = c), (e.originalMessage = d), e);
        }
        return (
          q(b, a),
      ...
      as = (function (a) {
        function b(b, c, d) {
          return (
            a.call(
              this,
              'Value for "'.concat(b, '" must be of type ').concat(c),
              m.INVALID_VALUE,
              d,
            ) || this
          );
          ...
          return (
            a.call(
              ...
              'The intl string context variable "'
                .concat(b, '" was not provided to the string "')
                .concat(c, '"'),
              m.MISSING_VALUE,
              c,
            ) || this
    ...
    (((f = n || (n = {}))[(f.literal = 0)] = "literal"),
      (f[(f.object = 1)] = "object"));
    var av = (function () {
      function a(b, c, d, e) {
        void 0 === c && (c = a.defaultLocale);
        var f,
          g,
          h = this;
        if (
          ...
          (this.format = function (a) {
            var b = h.formatToParts(a);
            if (1 === b.length) return b[0].value;
            var c = b.reduce(function (a, b) {
              return (
                a.length &&
                b.type === n.literal &&
                "string" == typeof a[a.length - 1]
                  ? (a[a.length - 1] += b.value)
                  : a.push(b.value),
                a
              );
            }, []);
          ...
          (this.formatToParts = function (a) {
            return (function a(b, c, d, e, f, g, h) {
              if (1 === b.length && B(b[0]))
                return [{ type: n.literal, value: b[0].value }];
              for (var j = [], k = 0; k < b.length; k++) {
                var l = b[k];
                if (B(l)) {
                  j.push({ type: n.literal, value: l.value });
                  continue;
                }
                if (l.type === i.pound) {
                  "number" == typeof g &&
                    j.push({
                      type: n.literal,
                      value: d.getNumberFormat(c).format(g),
                    });
                  continue;
                }
                var o = l.value;
                if (!(f && o in f)) throw new at(o, h);
                var p = f[o];
                ...
                if (D(l)) {
                  ...
                  j.push({
                    type: n.literal,
                    value: d.getDateTimeFormat(c, q).format(p),
                  });
                  continue;
                }
                if (E(l)) {
                  ...
                  var q =
                    "string" == typeof l.style
                      ...
                      : I(l.style)
                        ? l.style.parsedOptions
                        : void 0;
                  (q && q.scale && (p *= q.scale || 1),
                    j.push({
                      type: n.literal,
                      value: d.getNumberFormat(c, q).format(p),
                    }));
                  continue;
                }
                if (H(l)) {
                  var r = l.children,
                    s = l.value,
                    t = f[s];
                  if ("function" != typeof t) throw new as(s, "function", h);
                  var u = t(
                    a(r, c, d, e, f, g).map(function (a) {
                      return a.value;
                    }),
                  );
                  (Array.isArray(u) || (u = [u]),
                    j.push.apply(
                      ...
                      u.map(function (a) {
                        return {
                          type: "string" == typeof a ? n.literal : n.object,
                          value: a,
                        };
                      }),
                    ));
                ...
                if (F(l)) {
                  var v = l.options[p] || l.options.other;
                  if (!v) throw new ar(l.value, p, Object.keys(l.options), h);
                  j.push.apply(j, a(v.value, c, d, e, f));
                  continue;
                }
                if (G(l)) {
                  var v = l.options["=".concat(p)];
                  if (!v) {
                    if (!Intl.PluralRules)
                      throw new aq(
                    ...
                    var w = d
                      .getPluralRules(c, { type: l.pluralType })
                      .select(p - (l.offset || 0));
                    v = l.options[w] || l.options.other;
                  }
                  if (!v) throw new ar(l.value, p, Object.keys(l.options), h);
                  j.push.apply(j, a(v.value, c, d, e, f, p - (l.offset || 0)));
                  continue;
                }
              }
              return j.length < 2
                ...
                : j.reduce(function (a, b) {
                    var c = a[a.length - 1];
                    return (
                      c && c.type === n.literal && b.type === n.literal
                        ? (c.value += b.value)
                        : a.push(b),
                      a
                    );
                  }, []);
            })(h.ast, h.locales, h.formatters, h.formats, a, void 0, h.message);
          }),
          (this.resolvedOptions = function () {
            var a;
            return {
              locale:
                (null == (a = h.resolvedLocale) ? void 0 : a.toString()) ||
          ...
          (this.locales = c),
          (this.resolvedLocale = a.resolveLocale(c)),
          "string" == typeof b)
        ) {
          if (((this.message = b), !a.__parse))
            throw TypeError(
              "IntlMessageFormat.__parse must be set to process `message` of type `string`",
            );
          var j = e || {},
            k = (j.formatters, s(j, ["formatters"]));
          this.ast = a.__parse(b, r(r({}, k), { locale: this.resolvedLocale }));
        } else this.ast = b;
              ...
              (g = { number: {}, dateTime: {}, pluralRules: {} }),
            {
              getNumberFormat: u(
                function () {
                  for (var a, b = [], c = 0; c < arguments.length; c++)
                    b[c] = arguments[c];
                  return new ((a = Intl.NumberFormat).bind.apply(
                    a,
                    t([void 0], b, !1),
                  ))();
                },
                { cache: au(g.number), strategy: A.variadic },
              ),
              getDateTimeFormat: u(
                function () {
                  for (var a, b = [], c = 0; c < arguments.length; c++)
                    b[c] = arguments[c];
                  return new ((a = Intl.DateTimeFormat).bind.apply(
                    a,
                    t([void 0], b, !1),
                  ))();
                },
                { cache: au(g.dateTime), strategy: A.variadic },
              ),
              getPluralRules: u(
                function () {
                  for (var a, b = [], c = 0; c < arguments.length; c++)
                    b[c] = arguments[c];
                  return new ((a = Intl.PluralRules).bind.apply(
                    a,
                    t([void 0], b, !1),
                  ))();
                },
                { cache: au(g.pluralRules), strategy: A.variadic },
              ),
            })));
      }
      return (
        ...
        (a.resolveLocale = function (a) {
          if (void 0 !== Intl.Locale) {
            var b = Intl.NumberFormat.supportedLocalesOf(a);
            return new Intl.Locale(
              b.length > 0 ? b[0] : "string" == typeof a ? a : a[0],
            );
          }
        }),
        (a.__parse = ap),
    ...
    class aw extends Error {
      constructor(a, b) {
        ...
        (b && (c += ": " + b),
          super(c),
          (this.code = a),
          b && (this.originalMessage = b));
      }
    }
    var ax =
      (((g = ax || {}).MISSING_MESSAGE = "MISSING_MESSAGE"),
      (g.MISSING_FORMAT = "MISSING_FORMAT"),
      (g.ENVIRONMENT_FALLBACK = "ENVIRONMENT_FALLBACK"),
      (g.INSUFFICIENT_PATH = "INSUFFICIENT_PATH"),
      (g.INVALID_MESSAGE = "INVALID_MESSAGE"),
      (g.INVALID_KEY = "INVALID_KEY"),
      (g.FORMATTING_ERROR = "FORMATTING_ERROR"),
      g);
    function ay(...a) {
      return a.filter(Boolean).join(".");
    }
    function az(a) {
      return ay(a.namespace, a.key);
    }
    function aA(a) {
      console.error(a);
    }
    ...
    function aD(a, b) {
      return aC((...b) => new a(...b), b);
    }
    function aE(a) {
      return {
        getDateTimeFormat: aD(Intl.DateTimeFormat, a.dateTime),
        getNumberFormat: aD(Intl.NumberFormat, a.number),
        getPluralRules: aD(Intl.PluralRules, a.pluralRules),
        getRelativeTimeFormat: aD(Intl.RelativeTimeFormat, a.relativeTime),
        getListFormat: aD(Intl.ListFormat, a.list),
        getDisplayNames: aD(Intl.DisplayNames, a.displayNames),
      };
    }
    function aF(a, b, c, d) {
      let e = ay(d, c);
      ...
      return (
        c.split(".").forEach((b) => {
          let c = f[b];
          if (null == b || null == c) throw Error(e + ` (${a})`);
          f = c;
        }),
        f
      );
    ...
    var aH = a.i(99669);
    let aI = (0, o.createContext)(void 0);
    function aJ({
      children: a,
      formats: b,
      ...
      let i = (0, o.useContext)(aI),
        j = (0, o.useMemo)(() => i?.cache || aB(), [d, i?.cache]),
        k = (0, o.useMemo)(() => i?.formatters || aE(j), [j, i?.formatters]),
        l = (0, o.useMemo)(
          () => ({
            ...(function ({
              formats: a,
              getMessageFallback: b,
              messages: c,
              onError: d,
              ...e
            }) {
              return {
                ...
                messages: c || void 0,
                onError: d || aA,
                getMessageFallback: b || az,
              };
            })({
              locale: d,
              formats: void 0 === b ? i?.formats : b,
              getMessageFallback: c || i?.getMessageFallback,
              messages: void 0 === e ? i?.messages : e,
              now: f || i?.now,
              onError: g || i?.onError,
              timeZone: h || i?.timeZone,
            }),
            formatters: k,
            cache: j,
          }),
      ...
      return (0, aH.jsx)(aI.Provider, { value: l, children: a });
    }
    function aK() {
      let a = (0, o.useContext)(aI);
    ...
    function aM(a) {
      return (function (a, b, c) {
        let {
            ...
            formats: e,
            formatters: f,
            getMessageFallback: g,
            locale: h,
            onError: i,
            timeZone: j,
          } = aK(),
          k = a["!"],
          l = "!" === b ? void 0 : b.slice(2);
        return (
          j || aL || ((aL = !0), i(new aw(ax.ENVIRONMENT_FALLBACK, void 0))),
          (0, o.useMemo)(() => {
            var a;
            let b;
            return (
              (b = (function (a, b, c) {
                try {
                  if (!b) throw Error(void 0);
                  let d = c ? aF(a, b, c) : b;
                  if (!d) throw Error(c);
                  return d;
                } catch (a) {
                  return new aw(ax.MISSING_MESSAGE, a.message);
                }
              })(
                (a = {
                  cache: d,
              ...
              (function ({
                ...
                let j = f instanceof aw;
                function k(a, b, c, e) {
                  let f = new aw(b, c);
                  return (h(f), e ?? d({ error: f, key: a, namespace: g }));
                }
                function l(l, m, n, p) {
                  var q;
                  let r, s;
                  if (j) {
                    if (!p)
                      return (h(f), d({ error: f, key: l, namespace: g }));
                    r = p;
                  } else
                    try {
                      r = aF(e, f, l, g);
                    } catch (a) {
                      if (!p) return k(l, ax.MISSING_MESSAGE, a.message, p);
                      r = p;
                    }
                  if ("object" == typeof r) {
                    let a;
                    return k(
                      ...
                      Array.isArray(r)
                        ? ax.INVALID_MESSAGE
                        : ax.INSUFFICIENT_PATH,
                      a,
                    );
                  }
                  let t = ((q = r), m || /'[{}]/.test(q) ? void 0 : q);
                  if (t) return t;
                  c.getMessageFormat ||
                    (c.getMessageFormat = aC(
                      (...a) =>
                        new av(a[0], a[1], a[2], { formatters: c, ...a[3] }),
                      a.message,
                    ));
                  try {
                    let a, d, f, g;
                    s = c.getMessageFormat(
                      r,
                      e,
                      ((a = av.formats.date),
                      (d = av.formats.time),
                      (f = { ...b?.dateTime, ...n?.dateTime }),
                      (g = {
                        date: { ...a, ...f },
                        time: { ...d, ...f },
                        number: { ...b?.number, ...n?.number },
                      }),
                      i &&
                        ["date", "time"].forEach((a) => {
                          let b = g[a];
                      ...
                      g),
                      {
                        formatters: {
                          ...c,
                          getDateTimeFormat: (a, b) =>
                            c.getDateTimeFormat(a, { timeZone: i, ...b }),
                        },
                      },
                    );
                  } catch (a) {
                    return k(l, ax.INVALID_MESSAGE, a.message, p);
                  }
                  try {
                    let a,
                      b = s.format(
                    ...
                    if (null == b) throw Error(void 0);
                    return (0, o.isValidElement)(b) ||
                      Array.isArray(b) ||
                      "string" == typeof b
                      ? b
                      : String(b);
                  } catch (a) {
                    return k(l, ax.FORMATTING_ERROR, a.message, p);
                  }
                }
                function m(a, b, c, d) {
                  let e = l(a, b, c, d);
                  return "string" != typeof e
                    ? k(a, ax.INVALID_MESSAGE, void 0)
                    : e;
                }
                return (
                  (m.rich = l),
                  (m.markup = (a, b, c, d) => l(a, b, c, d)),
                  (m.raw = (a) => {
                    if (j) return (h(f), d({ error: f, key: a, namespace: g }));
                    try {
                      return aF(e, f, a, g);
                    } catch (b) {
                      return k(a, ax.MISSING_MESSAGE, b.message);
                    }
                  }),
                  (m.has = (a) => {
                    if (j) return !1;
            ...
            function h(a) {
              return (
                a?.timeZone ||
                  (g
                    ? (a = { ...a, timeZone: g })
                    : f(new aw(ax.ENVIRONMENT_FALLBACK, void 0))),
                a
              );
            }
            function i(a, b, c, d, e) {
              ...
              try {
                g = (function (a, b, c) {
                  ...
                  if ("string" == typeof b) {
                    if (!(d = a?.[b])) {
                      let a = new aw(ax.MISSING_FORMAT, void 0);
                      throw (f(a), a);
                    }
                  } else d = b;
                  return (c && (d = { ...d, ...c }), d);
              ...
              try {
                ...
                return (f(new aw(ax.FORMATTING_ERROR, a.message)), e());
              }
            }
            function j(a, b, f) {
              return i(
                ...
                f,
                d?.dateTime,
                (b) => ((b = h(b)), c.getDateTimeFormat(e, b).format(a)),
                () => String(a),
              );
            }
            function k() {
              return a.now
                ? a.now
                : (f(new aw(ax.ENVIRONMENT_FALLBACK, void 0)), new Date());
            }
            return {
              dateTime: j,
              number: function (a, b, f) {
                return i(
                  b,
                  f,
                  d?.number,
                  (b) => c.getNumberFormat(e, b).format(a),
                  () => String(a),
                );
              },
              relativeTime: function (a, b) {
                try {
                  ...
                  let f,
                    ...
                    h,
                    i = {};
                  (b instanceof Date || "number" == typeof b
                    ? (f = new Date(b))
                    : b &&
                      ((f = null != b.now ? new Date(b.now) : k()),
                      (g = b.unit),
                      (i.style = b.style),
                      (i.numberingSystem = b.numberingSystem)),
                    f || (f = k()));
                  let j = (new Date(a).getTime() - f.getTime()) / 1e3;
                  (g ||
                    (g =
                      (h = Math.abs(j)) < 60
                        ? "second"
                            ...
                            : h < 604800
                              ...
                              : h < 2628e3
                                ...
                                : h < 31536e3
                                  ? "month"
                                  : "year"),
                    (i.numeric = "second" === g ? "auto" : "always"));
                  let l = ((d = g), Math.round(j / aG[d]));
                  return c.getRelativeTimeFormat(e, i).format(l, g);
                } catch (b) {
                  return (f(new aw(ax.FORMATTING_ERROR, b.message)), String(a));
                }
              },
              list: function (a, b, f) {
                let g = [],
                  ...
                  (a) => {
                    let b = c
                      ...
                      .map((a) =>
                        "literal" === a.type
                          ? a.value
                          : h.get(a.value) || a.value,
                      );
                    return h.size > 0 ? b : b.join("");
                  },
                  () => String(a),
                );
              },
              dateTimeRange: function (a, b, f, g) {
                return i(
                  f,
                  g,
                  d?.dateTime,
                  (d) => (
                    (d = h(d)),
                    c.getDateTimeFormat(e, d).formatRange(a, b)
                  ),
                  () => [j(a), j(b)].join(" – "),
                );
              },
  ...
  (a) => {
    ...
    var b = a.i(61289),
      ...
      i = (a) =>
        b.useContext(f)
          ? b.createElement(b.Fragment, null, a.children)
          : b.createElement(k, { ...a }),
      j = ["light", "dark"],
      k = ({
        forcedTheme: a,
              ...
              let e = r ? r[b] : b,
                ...
                j = (a) => {
                  "class" === a
                    ...
                    : a.startsWith("data-") &&
                      (e ? i.setAttribute(a, e) : i.removeAttribute(a));
                };
...
//# sourceMappingURL=2798e_8beceec0._.js.map
