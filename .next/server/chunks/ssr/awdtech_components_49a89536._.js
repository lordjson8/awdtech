module.exports = [
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      () => {
        let a = (0, e.useTranslations)("MobilePage.Hero"),
          g = [
  ...
  (a) => {
    ...
    var b = a.i(99669),
      ...
      d = a.i(30289);
    function e() {
      let a = (0, c.useTranslations)("MobilePage.Features"),
        e = [
          {
            icon: (0, b.jsx)("svg", {
          ...
          },
          {
            ...
            title: a("crossPlatform.title"),
            description: a("crossPlatform.description"),
            linkText: a("crossPlatform.link"),
          },
          {
            icon: (0, b.jsx)("svg", {
              xmlns: "http://www.w3.org/2000/svg",
          ...
          },
          {
            ...
            title: a("integration.title"),
            description: a("integration.description"),
            linkText: a("integration.link"),
          },
          {
            icon: (0, b.jsx)("svg", {
              xmlns: "http://www.w3.org/2000/svg",
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      () => {
        let a = (0, e.useTranslations)("MobilePage.Expertise"),
          f = [
            {
              name: a("ios.name"),
              description: a("ios.description"),
              stack: [
                {
                  name: "Swift",
                  icon: (0, b.jsx)(c.FaSwift, { className: "text-orange-500" }),
                  level: a("ios.levelExpert"),
                },
                {
                  name: "Objective-C",
                  icon: (0, b.jsx)("span", {
                  ...
                  level: a("ios.levelAdvanced"),
                },
                {
                  name: "Xcode",
                  icon: (0, b.jsx)(d.SiXcode, { className: "text-blue-500" }),
                  level: a("ios.levelExpert"),
                },
              ],
              gradient: "from-blue-500 to-purple-600",
              projects: a("ios.projects"),
            },
            {
              name: a("android.name"),
              description: a("android.description"),
              stack: [
                {
                  name: "Kotlin",
                  icon: (0, b.jsx)(d.SiKotlin, {
                    className: "text-purple-500",
                  }),
                  level: a("android.levelExpert"),
                },
                {
                  name: "Java",
                  icon: (0, b.jsx)(c.FaJava, { className: "text-red-500" }),
                  level: a("android.levelAdvanced"),
                },
                {
                  name: "Android Studio",
                  icon: (0, b.jsx)(d.SiAndroidstudio, {
              ...
              projects: a("android.projects"),
            },
            {
              name: a("crossPlatform.name"),
              description: a("crossPlatform.description"),
              stack: [
                {
                  name: "React Native",
                  icon: (0, b.jsx)(c.FaReact, { className: "text-cyan-400" }),
                  level: a("crossPlatform.levelExpert"),
                },
                {
                  name: "Flutter",
                  icon: (0, b.jsx)(d.SiFlutter, { className: "text-blue-400" }),
                  level: a("crossPlatform.levelAdvanced"),
                },
                {
                  name: "Dart",
                  icon: (0, b.jsx)(d.SiDart, { className: "text-blue-600" }),
                  level: a("crossPlatform.levelAdvanced"),
                },
              ],
              gradient: "from-cyan-500 to-blue-600",
              projects: a("crossPlatform.projects"),
            },
            {
              name: a("backendCloud.name"),
              description: a("backendCloud.description"),
              stack: [
                {
                  name: "Node.js",
                  icon: (0, b.jsx)(c.FaNodeJs, { className: "text-green-500" }),
                  level: a("backendCloud.levelExpert"),
                },
                {
                  name: "Firebase",
                  icon: (0, b.jsx)(d.SiFirebase, {
                ...
                {
                  name: "AWS",
                  icon: (0, b.jsx)(c.FaAws, { className: "text-orange-500" }),
                  level: a("backendCloud.levelAdvanced"),
                },
                {
                  name: "GraphQL",
                  icon: (0, b.jsx)(d.SiGraphql, { className: "text-pink-500" }),
                  level: a("backendCloud.levelIntermediate"),
                },
              ],
              gradient: "from-orange-500 to-red-600",
              projects: a("backendCloud.projects"),
            },
          ],
          g = [
            { number: "50+", label: a("stats.deliveredApps") },
            { number: "95%", label: a("stats.clientSatisfaction") },
            { number: "3+", label: a("stats.yearsExperience") },
            { number: "15K+", label: a("stats.activeUsers") },
          ];
        return (0, b.jsxs)("section", {
          className:
                      ...
                      "div",
                      {
                        ...
                        children: [
                          (0, b.jsxs)("div", {
                            ...
                            children: [
                              (0, b.jsx)("div", {
                                className: `w-12 h-1 bg-gradient-to-r ${c.gradient} rounded-full mb-4 group-hover:w-16 transition-all duration-300`,
                              }),
                              (0, b.jsx)("h3", {
                                className:
                                    ...
                                    (0, b.jsx)("div", {
                                      ...
                                      children: [1, 2, 3].map((d) => {
                                        ...
                                        return (0, b.jsx)(
                                          "div",
                                          {
                                            className: `w-2 h-2 rounded-full transition-all duration-300 ${d <= ((e = c.level) === a("ios.levelExpert") || e === a("android.levelExpert") || e === a("crossPlatform.levelExpert") || e === a("backendCloud.levelExpert") ? 3 : e === a("ios.levelAdvanced") || e === a("android.levelAdvanced") || e === a("crossPlatform.levelAdvanced") || e === a("backendCloud.levelAdvanced") ? 2 : +(e === a("backendCloud.levelIntermediate"))) ? "bg-orange-500" : "bg-gray-300 dark:bg-gray-600"}`,
                                          },
                                          d,
                                        );
                                      }),
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      () => {
        let a = (0, f.useTranslations)("MobilePage.CallToAction");
        return (0, b.jsx)("section", {
          className:
...
//# sourceMappingURL=awdtech_components_49a89536._.js.map
