module.exports = [
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      () => {
        let a = (0, e.useTranslations)("ProjectsPage.CallToAction");
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      () => {
        let a = (0, c.useTranslations)("ProjectsPage.Hero");
  ...
  (a) => {
    ...
    function h({ className: a, ...c }) {
      return (0, b.jsx)("div", {
        ...
        className: (0, e.cn)("leading-none font-semibold", a),
        ...c,
      });
    }
    ...
    var k = a.i(8874),
      ...
      m = a.i(65916),
      n = a.i(16842);
    function o({ project: a }) {
      let c = (0, n.useTranslations)("ProjectsPage");
      return (0, b.jsxs)(f, {
        className:
    ...
    a.s(
      [
        ...
        0,
        () => {
          (0, n.useTranslations)("ProjectsPage.Categories");
          let [a, e] = (0, d.useState)("all"),
            f =
              "all" === a
                ? c.projects
                : c.projects.filter((b) => b.slug.includes(a));
          return (0, b.jsx)("section", {
            ...
            children: (0, b.jsx)("div", {
              ...
              children: (0, b.jsx)("div", {
                ...
                children: f.map((a) => (0, b.jsx)(o, { project: a }, a.id)),
              }),
            }),
          });
        },
...
//# sourceMappingURL=awdtech_5bcf9ed9._.js.map
