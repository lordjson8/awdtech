(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
      ...
      getSnapshotBeforeUpdate(e) {
        ...
        if (t && e.isPresent && !this.props.isPresent) {
          let e = t.offsetParent,
            r = ((0, h.isHTMLElement)(e) && e.offsetWidth) || 0,
    ...
    function b({ children: e, isPresent: s, anchorX: a, root: o }) {
      let i = (0, g.useId)(),
        n = (0, g.useRef)(null),
        l = (0, g.useRef)({ width: 0, height: 0, top: 0, left: 0, right: 0 }),
        { nonce: c } = (0, g.useContext)(x.MotionConfigContext),
        d = (function (...e) {
      ...
      return (
        (0, g.useInsertionEffect)(() => {
          let { width: e, height: t, top: r, left: d, right: m } = l.current;
          if (s || !n.current || !e || !t) return;
          let u = "left" === a ? `left: ${d}` : `right: ${m}`;
          n.current.dataset.motionPopId = i;
          let h = document.createElement("style");
          c && (h.nonce = c);
          let g = o ?? document.head;
          return (
            g.appendChild(h),
            h.sheet &&
              h.sheet.insertRule(`
        ...
        (0, t.jsx)(f, {
          ...
          childRef: n,
          sizeRef: l,
          children: g.cloneElement(e, { ref: d }),
        })
      );
    }
    let v = ({
      ...
      return (
        ...
        (0, t.jsx)(u.PresenceContext.Provider, { value: p, children: e })
      );
    };
    function y() {
      return new Map();
    ...
    let k = ({
      ...
      let [g, x] = (0, w.usePresence)(l),
        p = (0, r.useMemo)(() => N(e), [e]),
        f = l && !g ? [] : p.map(j),
        b = (0, r.useRef)(!0),
        y = (0, r.useRef)(p),
        k = (0, d.useConstant)(() => new Map()),
        [C, S] = (0, r.useState)(p),
        [E, F] = (0, r.useState)(p);
      (0, m.useIsomorphicLayoutEffect)(() => {
        ((b.current = !1), (y.current = p));
        for (let e = 0; e < E.length; e++) {
          let t = j(E[e]);
          f.includes(t) ? k.delete(t) : !0 !== k.get(t) && k.set(t, !1);
        }
      }, [E, f.length, f.join("-")]);
      let P = [];
      if (p !== C) {
        ...
        for (let t = 0; t < E.length; t++) {
          let r = E[t],
            s = j(r);
          f.includes(s) || (e.splice(t, 0, r), P.push(r));
        }
        return ("wait" === n && P.length && (e = P), F(N(e)), S(p), null);
      }
      let { forceRender: T } = (0, r.useContext)(c.LayoutGroupContext);
      return (0, t.jsx)(t.Fragment, {
        children: E.map((e) => {
          let r = j(e),
            c = (!l || !!g) && (p === E || f.includes(r));
          return (0, t.jsx)(
            v,
            {
              isPresent: c,
    ...
    var C = e.i(78766);
    function S() {
      (0, n.useTranslations)("ContactPage");
      let [e, a] = (0, r.useState)({
        ...
        [c, d] = (0, r.useState)(!1),
        [m, u] = (0, r.useState)("idle"),
        h = async (t) => {
          t.preventDefault();
          let r = localStorage.getItem("lastFormSubmission");
          if (
            (r && Date.now() - parseInt(r) < 3e4) ||
            !e.name.trim() ||
            !e.email.trim() ||
            !e.message.trim() ||
            !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.email)
          ) {
            (u("error"), setTimeout(() => u("idle"), 3e3));
            return;
          }
          d(!0);
          try {
            let t = await fetch("/api/contact", {
              ...
              r = await t.json();
            if (!t.ok) throw Error(r.message || "Submission failed");
            (d(!1),
              u("success"),
            ...
            let s = setTimeout(() => u("idle"), 5e3);
            return () => clearTimeout(s);
          } catch (e) {
            (console.error("Form submission error:", e),
              d(!1),
              u("error"),
              setTimeout(() => u("idle"), 3e3));
          }
        },
        g = (e) => {
        ...
        p = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } },
        f = [
          {
            name: "facebook",
            icon: (0, t.jsx)(C.FaFacebook, { className: "w-5 h-5" }),
            href: "https://facebook.com/awdtech",
            color: "hover:bg-[#1877F2] hover:text-white",
          },
          {
            name: "twitter",
            icon: (0, t.jsx)(C.FaTwitter, { className: "w-5 h-5" }),
            href: "https://twitter.com/awdtech",
            color: "hover:bg-[#1DA1F2] hover:text-white",
          },
          {
            name: "linkedin",
            icon: (0, t.jsx)(C.FaLinkedinIn, { className: "w-5 h-5" }),
            href: "https://linkedin.com/company/awdtech",
            color: "hover:bg-[#0077B5] hover:text-white",
          },
          {
            name: "whatsapp",
            icon: (0, t.jsx)(C.FaWhatsapp, { className: "w-5 h-5" }),
        ...
        b = [
          ...
          {
            icon: (0, t.jsx)(C.FaPhone, { className: "w-5 h-5 sm:w-6 sm:h-6" }),
            title: "Cameroun",
          ...
          {
            icon: (0, t.jsx)(C.FaGlobe, { className: "w-5 h-5 sm:w-6 sm:h-6" }),
            title: "Service",
              ...
              (0, t.jsxs)(l.motion.div, {
                ...
                children: [
                  ...
                  (0, t.jsx)(l.motion.div, {
                    ...
                    children: b.map((e, r) =>
                      (0, t.jsxs)(
                        ...
                        {
                          href: e.action,
                          target: "#" === e.action ? void 0 : "_blank",
                          rel:
                            "#" === e.action ? void 0 : "noopener noreferrer",
                          className:
                  ...
                  (0, t.jsxs)(l.motion.div, {
                    ...
                    `,
                              "aria-label": `Suivez AWDTECH sur ${e.name}`,
                              children: e.icon,
                            },
                            e.name,
                          ),
