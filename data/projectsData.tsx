...
export const projectsData = [
  {
    ...
    description:
      "Scalable e-commerce platform serving 50K+ daily users with real-time inventory, AI-powered recommendations, and multi-vendor support.",
  ...
  },
  {
    ...
    description:
      "Intelligent fitness platform using machine learning for personalized workout plans, form analysis, and progress tracking.",
