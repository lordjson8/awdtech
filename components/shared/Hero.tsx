...
export default function Hero() {
  ...
  return (
    <section className="bg-[linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('/hero.png')] bg-cover bg-center bg-no-repeat h-[80vh] place-content-center dark:bg-gray-900">
