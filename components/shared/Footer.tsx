        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              ...
              {/* <li>
                <a
                  href="https://www.sonatel.sn/"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-500 dark:text-gray-300 transition hover:text-orange-500"
                >
                  <span className="sr-only">Sonatel</span>
                  <Image height={24} width={24} src="/logo.svg" alt="sn-logo" className="size-6" />
                </a>
              </li> */}
            </ul>
          </div>
