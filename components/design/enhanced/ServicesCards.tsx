  ...
  const services = [
    {
      ...
      features: [t('uiux.features.0'), t('uiux.features.1'), t('uiux.features.2'), t('uiux.features.3')]
    },
    {
      ...
      features: [t('branding.features.0'), t('branding.features.1'), t('branding.features.2'), t('branding.features.3')]
    },
    {
      ...
      features: [t('prototyping.features.0'), t('prototyping.features.1'), t('prototyping.features.2'), t('prototyping.features.3')]
    },
  ];
