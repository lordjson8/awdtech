  ...
  const socialLinks = [
    {
      ...
      href: "https://twitter.com/designstudio",
    ...
    },
    {
      ...
      href: "https://behance.net/designstudio",
      color: "hover:bg-[#0057FF] hover:text-white",
    },
  ];
  ...
  const contactInfo = [
    {
      ...
      action: "mailto:hello@designstudio.com",
    },
    {
      ...
      <div className="w-full max-w-7xl mx-auto py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              {contactInfo.map((item, index) => (
                <a
                  ...
                  className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-orange-500 dark:hover:border-orange-500 transition-all duration-300 group"
                >
                  <div className="p-2 sm:p-3 bg-orange-50 dark:bg-orange-500/10 rounded-lg sm:rounded-xl text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                    {item.icon}
                  </div>
                  <div className="min-w-0">
                    <h3 className="font-semibold text-gray-900 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors duration-300 text-sm sm:text-base">
                      {item.title}
                    </h3>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 lg:p-10 shadow-xl">
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          required
                          className="h-11 sm:h-12 border-gray-300 dark:border-gray-600 focus:border-orange-500 focus:ring-orange-500 transition-colors"
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        rows={4}
                        cols={20}
                        className="border-gray-300 dark:border-gray-600 h-[200px] focus:border-orange-500 focus:ring-orange-500 transition-colors resize-none text-sm sm:text-base"
            ...
            <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 w-10 h-10 sm:w-16 sm:h-16 bg-purple-500 rounded-full opacity-20"></div>
          </motion.div>
        </div>
      </div>
    </div>
