...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900/20 text-white overflow-hidden">
      ...
      <div
        className="absolute top-40 right-20 w-6 h-6 bg-orange-400 rounded-full opacity-40 animate-float"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute bottom-20 left-1/4 w-3 h-3 bg-orange-300 rounded-full opacity-50 animate-float"
      ...
      <div className="container relative mx-auto px-4 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg md:text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Nous créons des applications mobiles{" "}
            <span className="text-orange-400 font-semibold">
              scalables, robustes et riches en fonctionnalités
            </span>
            pour Android et iOS, transformant vos idées en expériences
