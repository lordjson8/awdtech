      ...
      <div className="container px-6 py-10 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
          <div className="flex flex-col gap-4">
            <h1 className="text-4xl font-extrabold">The Team</h1>
           <p className="font-base">
             GOHZE is a dynamic company founded by talented young engineers who
            graduated from Polytechnique de Yaoundé. We specialize in enterprise
            digitalization and are committed to providing innovative and
